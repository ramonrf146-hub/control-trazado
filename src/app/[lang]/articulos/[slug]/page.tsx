...
export default async function ArticuloPage({ params }: Props) {
  ...
  const articuloJsonLd = {
    ...
    author: { "@type": "Organization", name: "Control Trazado" },
    publisher: { "@type": "Organization", name: "Control Trazado" },
  ...
  const breadcrumbJsonLd = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: d["nav.guias"], item: `${SITE_URL}${withLocale("/articulos", locale)}` },
      ...(categoria
        ? [
            {
              "@type": "ListItem",
