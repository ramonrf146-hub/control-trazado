 ...
 */
export default function AmazonDisclosureToast({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={d["disclosure.verAviso"]}
      ...
      {mostrarInfo && (
        ...
        >
          <strong className="text-text-light">{d["disclosure.aviso"]}</strong>{" "}
          {d["disclosure.texto"]}
        </div>
      )}
    </>
