 ...
 * usar el vocabulario correcto frente a un cliente o un manual. No tiene
 * sentido para el locale "en" (ya explica términos EN a hispanohablantes).
 */
export default function GlosarioDeCampo({ producto, locale }: { producto: Producto; locale: Locale }) {
  ...
  if (locale === "en" || terminos.length === 0) return null;
